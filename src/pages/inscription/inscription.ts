...
export class InscriptionPage {
	...
	send() {
		if (
			...
			this.body = {
				sujet: this.afProv.buildInscriptionMessage(this.form)
			};
			
			console.log('Message => ', this.body, 'object ===> ', this.form);
			let messageError = "Votre email n'a pas été envoyer.";
			let subject = "Inscription Au Forum ABBW 2019";
			this.afProv.doEmail(this.emailTosend, messageError, subject, this.body.sujet);
